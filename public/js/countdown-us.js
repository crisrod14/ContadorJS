var CountdownBannerInterval = setInterval(function () {
    if (typeof JetSmart === "undefined" || JetSmart.TealiumData.culture !== 'en-US' || !document.querySelector('bb-searchbox')) return;
    ...
    const COUNTDOWN_RANGES = [
        ...[
  {boldText: 'SMART Days', plainText: 'Take advantage before it ends!', icon: '<i class="fa-solid fa-lightbulb-on"></i>', smartDaysGlow: true, start_date: '2025-05-12T10:00:00', end_date: '2025-05-19T10:00:00', showCTA: false, type: 'evento-comercial'}
],
        ...[]
    ];

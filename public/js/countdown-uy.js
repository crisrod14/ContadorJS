var CountdownBannerInterval = setInterval(function () {
    if (typeof JetSmart === "undefined" || JetSmart.TealiumData.culture !== 'es-UY' || !document.querySelector('bb-searchbox')) return;
    ...
    const COUNTDOWN_RANGES = [
        ...[
  {boldText: 'SMART Days', plainText: '¡Aprovechá antes que se acabe!', icon: '<i class="fa-solid fa-lightbulb-on"></i>', smartDaysGlow: true, start_date: '2025-05-12T10:00:00', end_date: '2025-05-19T10:00:00', showCTA: false, type: 'evento-comercial'}
],
        ...[]
    ];

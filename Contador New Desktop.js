var CountdownBannerInterval = setInterval(function () {
    ...
    const COUNTDOWN_RANGES = [
      {
        type: 'evento-comercial', // Tipo de contador
        ...
        ctaText: 'Ver ofertas',
        ctaLink: 'https://jetsmart.com/ofertas/es-cl/smart-days-chile',
        showCTA: false,
        smartDaysGlow: true
      },
      // Promo Flash Brasil
      {
        type: 'promo-flash',
        start_date: '2024-05-12T18:00:00',
        end_date: '2024-05-13T10:00:00',
      ...
      {
        type: 'promo-flash',
        start_date: '2024-05-13T11:00:00',
        end_date: '2024-05-13T19:00:00',
        boldText: 'Promo Flash',
        icon: '<i class="fa-solid fa-bolt"></i>',
      ...
      {
        type: 'promo-flash',
        start_date: '2024-05-14T18:00:00',
